...
func (m MasterWMD) GetAliases() []string {
	var aliases []string
	for _, a := range []*string{m.Alias1, m.Alias2, m.Alias3, m.Alias4, m.Alias5, m.Alias6, m.Alias7, m.Alias8, m.Alias9, m.Alias10} {
		if a != nil && *a != "" {
...
func (m MasterWMD) GetUpdatedAt() *time.Time    { return m.UpdatedAt }
